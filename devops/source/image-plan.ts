...
const Riscv64BuilderSnapshotEvidence = 'https://snapshot.debian.org/archive/debian/20260713T000000Z'
...
const RoleDescriptions: Readonly<Record<ImageRole, string>> = {
  ...
  'filebelt-revision': 'FileBelt immutable revision coordinator',
