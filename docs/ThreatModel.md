...
| Retained OxiBelt AMD64 evidence is forged, replaced, or detached from the pinned web base and multi-platform index | Offline GitHub/Sigstore verification against a retained trusted root and raw manifest subjects; exact certificate/OIDC/source/runner policy; direct Dockerfile binding; retained bundle hashes; and exact index, child, source, role, platform, and target-CPU predicates | Offline signature verification, forged-signature, Dockerfile-drift, and bundle-tamper tests |
