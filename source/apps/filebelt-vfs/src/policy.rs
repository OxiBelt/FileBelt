...
pub fn register_recursive_share_metrics(operations: &OperationsState) {
...
) -> Result<RecursiveShareResolvedAclEntry, ()> {
...
mod tests {
    ...
    #[test]
    fn mount_policy_rejects_a_self_only_manager_descendant_share() {
