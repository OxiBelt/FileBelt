...
def check(root: Path) -> list[str]:
    ...
    required_files = [
        ...
        *REQUIRED_LIVING_SPECS,
        ...
        "supply-chain/license-compatibility-v1.toml",
        "supply-chain/imports.lock",
        "tests/scripts/check-cargo-boundaries.py",
        "tests/scripts/check-cargo-boundaries.sh",
        "tests/scripts/check-license-compatibility.py",
        "tests/scripts/test_check_license_compatibility.py",
        ...
        ".github/workflows/adapter-license-qualification.yml",
        ".github/workflows/adapter-release.yml",
        ...
        "tests/scripts/package-adapter-source-bundle.py",
        "tests/scripts/validate-adapter-source-bundle.py",
        "tests/scripts/validate-adapter-publication.py",
        "tests/scripts/run-adapter-bundle-image.py",
