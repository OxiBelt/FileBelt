...
describe("FileBelt Markdown links", () => {
  it("accepts only the canonical drive/node form", () => {
    expect(
      ParseFileBeltReference(
        "filebelt://drive/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa/node/bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb?version=cccccccc-cccc-4ccc-8ccc-cccccccccccc",
      ),
    ).toEqual({
      DriveId: "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
