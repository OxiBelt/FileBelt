...
import { MarkdownSourceEditor, type MarkdownCollaboration } from "./editor.js";
import { ParseFileBeltGfmV1 } from "./parser.js";
import { MarkdownPreview } from "./renderer.js";
import type { CollaborationIdentity, MarkdownMode, MarkdownSource, MarkdownStrings } from "./types.js";
...
export function MarkdownSurface({ Collaboration, Disabled, Identity, Mode, OnFileBeltLink, OnModeChange, OnSelectionChange, OnTextChange, Source, Strings }: MarkdownSurfaceProps): JSX.Element {
  ...
  return <section data-filebelt-markdown-mode={Mode}>
    ...
    <div aria-label={Strings.Edit} hidden={!ShowSource} id={SourcePanelId} role="tabpanel"><MarkdownSourceEditor {...(Collaboration === undefined ? {} : { Collaboration })} {...(Disabled === undefined ? {} : { Disabled })} {...(Identity === undefined ? {} : { Identity })} {...(OnSelectionChange === undefined ? {} : { OnSelectionChange })} {...(OnTextChange === undefined ? {} : { OnTextChange })} Source={Source} SourceEditorLabel={Strings.SourceEditor} /></div>
